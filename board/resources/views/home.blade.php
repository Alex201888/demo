...
@section('content')
<div class="page activities-list">
                                ...
                                <div class="desc">
                                    <div>
                                        <div class="activity-location">
                                            <p class="grey-txt activity-location-formatted">{{ $value->location }}</p>
                                        </div>
                                        <div class="activity-organizer">
                                            <p><i class="blue-txt activity-organizer-formatted">User ID:
                                                    {{ $value->user_id }}</i>
                                            </p>
                                        </div>
                                    </div>
                                    <a href="{{ URL::to('/detail') }}/{{ $value->id }}"
                                        class="btn btn-small">register</a>
                                </div>
                            </div>
                        </div>
						@if($key%3==2)

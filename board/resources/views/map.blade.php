...
@section('content')
    ...
    <div class="d-flex align-items-stretch" style="height: 10%;">
        <div class="title-with-line">
            <h4 class="blue-txt">activities on map</h4>
        </div>
    </div>
    <!--Google map-->
    <div id="map" class="d-flex align-items-stretch" style="min-height: 900px; height:100%">
...
<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1SFOGwCUZWnB89IbEk1iKrsfbxtG9KWs&callback=initMap&language=en"
...
function initMap() {
    ...
    function createMarker(point, index, address) {
        ...
        var infowindow = new google.maps.InfoWindow({
            content: address + ' Event Title:' + arrayTitle[index] + ' Start Date:' + arrayDate[index]
        });
